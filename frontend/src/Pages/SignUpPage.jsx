...
const SignUpPage = () => {
  ...
  const { signup, loggedUser, isLoading } = authStore();
  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="rounded-2xl shadow-2xl p-8 w-full max-w-md bg-gradient-to-r from-gray-500 to-gray-800 relative overflow-hidden">
        ...
        <div className="absolute -bottom-8 -right-8 w-32 h-32 bg-purple-400 opacity-20 rounded-full animate-pulse"></div>
        ...
        <div className="relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                type="text"
                className="w-full px-4 py-2 bg-gray-700 text-white rounded-lg focus:ring-2 focus:ring-blue-400 outline-none"
                placeholder="Enter your username"
                value={username}
                onChange={(e) => setUsername(e.target.value)}
                required
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-lg font-semibold hover:scale-105 transition disabled:opacity-50"
            >
